...
class GFPayPal extends GFPaymentAddOn {
	...
	public function feed_list_no_item_message(){
		...
		if ( ! rgar( $settings, 'gf_paypal_configured' ) ){
			return sprintf( __( 'To get started, let\'s go configure your %sPayPal Settings%s!', 'gravityforms' ), '<a href="' . admin_url( 'admin.php?page=gf_settings&subview=' . $this->_slug ) . '">', '</a>' );
		}
		else {
	...
	public function temporary_plugin_page(){
		...
		<div class="wrap about-wrap">
			<h1>PayPal Add-On v2.0</h1>
			<div class="about-text">Thank you for updating! The new version of the Gravity Forms PayPal Standard Add-On makes changes to how you manage your PayPal integration.</div>
			<div class="changelog">
				<hr/>
				<div class="feature-section col two-col">
					<div class="col-1">
						<h3>Manage PayPal Contextually</h3>
						<p>PayPal Feeds are now accessed via the PayPal sub-menu within the Form Settings for the Form you would like to integrate PayPal with.</p>
					</div>
				...
				<form method="post" id="dismiss_menu_form" style="margin-top: 20px;">
					<input type="checkbox" name="dismiss_paypal_menu" value="1" onclick="dismissMenu();"> <label>I understand this change, dismiss this message!</label>
					<img id="gf_spinner" src="<?php echo GFCommon::get_base_url() . '/images/spinner.gif'?>" alt="Please wait..." style="display:none;"/>
				</form>
